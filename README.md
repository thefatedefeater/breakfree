...
>[!IMPORTANT]
>Sing-Box versions before 1.8.0 are deprecated and will not work with this config. Please upgrade.  
>نسخه‌های پیش از 1.8.0 سینگ‌باکس منقضی شده‌اند و با این کانفیگ کار نخواهند کرد. لطفا آپدیت کنید.
